...
url += '&scope=playlist-modify-public%20playlist-modify-private';
...
const Spotify = {
  ...
  savePlaylist(playlistName, playlistTracks) {
    ...
    let userId = ''
    let playlistId = ''
    return axios.get(`${url}/v1/me`, { headers: header })
      .then(result => userId = result.data.id)
      .then(() => {
        return axios.post(`${url}/v1/users/${userId}/playlists`, {
          name: playlistName,
      ...
      .then(() => axios.post(`${url}/v1/users/${userId}/playlists/${playlistId}/tracks`, { uris: playlistTracks }, { headers: header }))
